function derivatives = evaluateDerivativeInModelSpace(this, points, outputIndex)
...
%
% Signature:
%	derivatives = evaluateDerivativeInModelSpace(this, points, outputIndex)
%
% Description:
...
for i=1:size(points,1)
	jacobian = this.predict_derivatives( points(i,:) );
