...
**
** Revision: $Id: KotanchekSimulator.java 6376 2009-12-11 10:13:11Z dgorissen $
**-----------------------------------------------------------------------------------------
*/
...
/**
 * Simulator for a Kotanchekfunction
 * @author COMS
 */
public class KotanchekSimulator extends AbstractSimulator {
	...
	public void simulate(SamplePoint point) throws SampleEvaluatorException {
		...
		results[0] = Math.exp( -y*y ) / (1.2 + x*x );		
		results[1] = results[0] + 0.0001 * (2*Math.random() - 1.0);
	}
