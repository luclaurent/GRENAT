...
**
** Revision: $Id: AbstractSimulator.java 6376 2009-12-11 10:13:11Z dgorissen $
**-----------------------------------------------------------------------------------------
*/
...
import ibbt.sumo.sampleevaluators.Simulator;
...
public abstract class AbstractSimulator implements Simulator {
	...
	/*
	 *(non-Javadoc)
	 * @see ibbt.sumo.sampleevaluators.Simulator#simulate(ibbt.sumo.sampleevaluators.SamplePoint)
	 */
	...
	public abstract void simulate(SamplePoint point) throws SampleEvaluatorException;
	
	/*
	 *(non-Javadoc)
	 * @see ibbt.sumo.sampleevaluators.Simulator#configure(java.util.Properties)
	 */
