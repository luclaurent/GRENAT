...
%	functions for this model. inFunc is simulator -> model space, outFunc
%	is model -> simulator space.

[inFunc, outFunc] = calculateTransformationFunctions(m.transformationValues);
