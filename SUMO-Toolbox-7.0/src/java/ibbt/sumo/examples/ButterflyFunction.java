...
**
** Revision: $Id: ButterflyFunction.java 6376 2009-12-11 10:13:11Z dgorissen $
**-----------------------------------------------------------------------------------------
*/
 ...
 */
public class ButterflyFunction  extends AbstractSimulator{
	
	public ButterflyFunction() {
		super();
	}
	...
	public void simulate(SamplePoint point) throws SampleEvaluatorException {
		...
		//scale from [-1 1] to [0 400]
		x = MathUtil.scale(-1,1,0,400,x);
		y = MathUtil.scale(-1,1,0,400,y);

		double res = (x*x - y*y) * Math.sin(x + y) / (x*x + y*y);
