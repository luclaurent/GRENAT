...
**
** Revision: $Id: TestFunction3.java 6376 2009-12-11 10:13:11Z dgorissen $
**-----------------------------------------------------------------------------------------
*/
 ...
 */
public class TestFunction3  extends AbstractSimulator {
	...
	public void simulate(SamplePoint point) throws SampleEvaluatorException {
		...
		//scale to [-2 2] to [-4 4] and [-6 2]
		x = x*2;
		y = y*2;

		double res = Math.pow(Math.max(Math.abs(x), Math.abs(y)),2);
