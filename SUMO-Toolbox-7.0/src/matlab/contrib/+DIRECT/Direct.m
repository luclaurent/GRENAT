...
%
%The code was slighty modified in the following way by sumo@intec.ugent.be:
%- support for returning constraints in the objective function removed
%- constraints are given as function handles, not as strings
%- display termination messages only when showits = 1
%
%code downloaded from: http://www4.ncsu.edu/~ctk/matlab_darts.html
%
%This file was downloaded and added to the toolbox on 22th october, 2007.%
...
if isfield(Problem,'constraint')
    if ~isempty(Problem.constraint)
        for i = 1:Problem.numconstraints
            con_value = Problem.constraint(i).func( point,varargin{:} );
