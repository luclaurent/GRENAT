...
%construction des m�tamod�les
type_conf={'KRG','CKRG','RBF','GRBF'};
...
%%% Evalution de la fonction de r�f�rences
...
%sauvegarde
fichier=['MOY_QUAL_' doe.fct '_' algo_estim '_' num2str(doe.dim_pb) 'D.mat'];
save(fichier)
