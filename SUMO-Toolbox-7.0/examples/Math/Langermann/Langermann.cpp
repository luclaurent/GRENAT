 ...
 * Taken from: http://www.ewh.ieee.org/soc/es/May2001/14/Begin.htm
 */

double min = 500;
double Langerman_a[30][10] = {
...
double
langerman(register double x[], register int n)  /* Langerman's function */
{
	...
	for ( i = 0; i < 5; i++ )
	  {
	    ...
	    Sum -= Langerman_c[i] * (exp(-dist/PI) * cos( PI * dist ) );
	  }
