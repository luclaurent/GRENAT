...
**
** Revision: $Id: RosenbrockSimulator.java 6376 2009-12-11 10:13:11Z dgorissen $
**-----------------------------------------------------------------------------------------
*/
...
/**
 * Simulator for Rosenbrocks function
 * @author COMS
 */
public class RosenbrockSimulator extends AbstractSimulator {

	public RosenbrockSimulator() {
		super();
	}
	...
	public void simulate(SamplePoint point) throws SampleEvaluatorException {
		...
		results[0] = 100*Math.pow((y - x*x),2) + ((1-x)*(1-x));
		results[1] = Math.log(results[0]);
	}
